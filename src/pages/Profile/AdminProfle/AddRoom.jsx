            ...
            <div className="flex flex-col gap-6 justify-center items-center">
                <div className="flex flex-row">
                    <form className="flex flex-col text-sm gap-6 justify-center items-center">
                        ...
                        <input type="number" placeholder='prix nuit' className=' outline-none w-2/3 p-4 border-b-2 border-orange-600' />
                        <input type="number" placeholder='prix heures' className=' outline-none w-2/3 p-4 border-b-2 border-orange-600' />
                    </form>
