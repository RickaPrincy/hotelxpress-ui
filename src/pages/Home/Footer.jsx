import LS from "../../../public/Facebook.png"
import LS2 from "../../../public/google.png"
function Footer() {
    return (
            ...
            <div className="flex flex-col ">
                ...
                <div className="flex flex-row justify-center gap-96 pb-6">
                    <div className="flex flex-col">
                        ...
                        <img src={LS} alt="" className=" flex rounded-lg"/>
                        <img src={LS2} alt="" className=" flex rounded-lg"/>
                        </div>
                    </div>
                    <div className="flex flex-col">
                        <span className="font-bold text-white text-xl">Telephone</span>
                        <span className="text-gray-400">+261345810480</span>
                    </div>
                </div>
            </div>
